...
6. **`tests/`** — e.g. test_standalone_scorer.py, test_session.py, test_verifier.py. **CI** (`.github/workflows/ci.yml`) runs on push/PR/manual and includes core lint+tests plus frontend and Postgres convergence jobs.
