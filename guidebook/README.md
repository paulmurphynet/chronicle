...
- **How Chronicle addresses it** — Evidence and claims, a defensibility score, a portable .chronicle format, a verifier (with clear [verification guarantees](../docs/verification-guarantees.md)), and how we fit into your ecosystem (one-command RAG path, scorer, APIs, adapters, provenance).
