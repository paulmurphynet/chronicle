...
| **Defeater types** | We **record** optional **defeater_kind** (rebutting | undercutting) on challenge links and tensions. We do **not** compute or validate that a link is correctly classified; defeater semantics are not implemented. |
