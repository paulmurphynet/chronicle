...
- **Producers** should generate `.chronicle` files that pass the verifier. See [Verifier](verifier.md) for how to run it; [Implementer checklist](implementer-checklist.md) for a produce/consume checklist.
